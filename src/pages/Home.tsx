...
const Home = () => {
  ...
  return (
    <div className="min-h-screen w-full overflow-hidden">
      {/* ---------------- Hero Section ---------------- */}
      <section className="gradient-hero pt-32 md:pt-40 pb-16 md:pb-20 px-4 md:px-6 text-center flex flex-col items-center justify-center min-h-[80vh] md:min-h-[90vh]">
        ...
        >
          Welcome to{" "}
          <span className="text-[#FF5940] font-semibold font-gotham">Kutlerri</span>, the
...
>
  <Link
    ...
    className="
      ...
      rounded-full 
      border-2 border-[#FF5940] 
      text-black font-semibold 
      text-base sm:text-lg md:text-xl 
      whitespace-nowrap 
      flex items-center justify-center 
      hover:bg-[#FF5940] hover:text-white 
            ...
            {[
              ...
              >
                <CardContent className="p-8 md:p-10 flex flex-col flex-grow text-center items-center">
                  ...
                  <p className="font-gotham text-[15px] leading-[150%] text-[#FF5940] mb-3">
                    {card.subtitle}
                  </p>
